...
import { Category, Device, Hwconf, Room, SoftwareStatus, Software, License, Installation } from '../models/data-model';
...
export class SoftwareService {
	hostname: string;
	url: string = "";
	selectedInstallationSet: Category = new Category();
	...
	addSoftwareLicense(softwareId: number, form: any) {
		this.url = this.hostname + `/softwares/${softwareId}/license`;
		console.log(this.url);
		return this.http.post<ServerResponse>(this.url, form, { headers: this.authService.formHeaders });
	}
	modifySoftwareLicense(licenseId: number, form: any) {
		this.url = this.hostname + `/softwares/licenses/${licenseId}`;
		console.log(this.url);
		return this.http.post<ServerResponse>(this.url, form, { headers: this.authService.formHeaders });
	}
