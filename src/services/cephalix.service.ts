...
import { Institute, Ticket, Article, Notice, CephalixCare, DynDns, Repository, CephalixMapping } from '../models/cephalix-data-model';
import { ServerResponse, CrxActionMap } from '../models/server-models';
import { AuthenticationService } from './auth.service';
import { InstituteStatus } from '../models/cephalix-data-model';
import { Hwconf, User } from '../models/data-model';
...
export class CephalixService {
	...
	getObjectsToSynchronize() {
		...
		console.log(this.url);
		return this.http.get<CephalixMapping[]>(this.url, { headers: this.authService.headers });
	}
	...
	getHWconfFromInstitute(instituteId: number, hwconfid: number, hwconf: Hwconf) {
	...
	syncHWconfFromInstitute(instituteId: number, mapping: CephalixMapping) {
	...
	addUserToInstitute(userId: number, instituteId: number) {
	...
	deleteUserFromInstitute(userId: number, instituteId: number) {
		this.url = this.hostname + `/institutes/${instituteId}/users/${userId}`;
		console.log(this.url)
