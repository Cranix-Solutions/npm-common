...
export class SecurityService {
  ...
  hostname: string;
  url: string = "";
  incomingRules: IncomingRules = new IncomingRules();
  ...
  setProxyCustom(custom: string, list: string[]) {
    this.url = this.hostname + `/system/proxy/custom/${custom}`;
    console.log(this.url);
    return this.http.post<ServerResponse>(this.url, list, { headers: this.authService.headers });
  }
  ...
  setFirewallStatus(status: string) {
  ...
  addOutgoingRule(rule: OutgoingRule) {
    this.url = this.hostname + '/system/firewall/outgoingRules';
    console.log(this.url);
    this.objectService.requestSent();
  ...
  deleteOutgoingRule(rule: OutgoingRule) {
  ...
  deleteRemoteRule(rule: RemoteRule) {
  ...
  readDatas() {
    this.incomingRules = new IncomingRules();
    this.outgoingRules = [];
    this.remoteRules = [];
